...
createAnalysesDetails <- function(connectionDetails, cdmDatabaseSchema, workFolder) {
  ...
  # Get all Sisyphus challenge:  negative controls for alendronate and raloxifene Concept IDs for empirical calibration ----
  sql <- paste("select distinct I.concept_id FROM
               (
  ...
  cmAnalysis1 <- CohortMethod::createCmAnalysis(analysisId = 1,
                                                description = "Sisyphus challenge:  Comparative effectiveness of alendronate vs. raloxifene in patients with osteoporosis for the risk of hip fracture",
