---
title: "Alendronate vs Raloxifen study"
output: 
    word_document:
        fig_caption: yes
        toc: yes
params: 
    exportFolder: S:/temp/AlendronateVsRaloxifenMdcd/export
---
...
In total, 1 analyses variation was executed:
...
```{r, echo = FALSE, fig.width = 5, fig.height= 4, fig.cap = "Kaplan-Meier plot. Shaded areas indicate the 95% confidence interval. Note that this plot does not take into account stratification, as done when fitting the Cox model."}
