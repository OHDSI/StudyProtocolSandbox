...
WHERE C.ordinal = 1
AND C.drug_exposure_start_date < DATEFROMPARTS(2012, 02, 01)
...
WHERE DATEADD(day,365,OP.OBSERVATION_PERIOD_START_DATE) <= P.START_DATE AND DATEADD(day,90,P.START_DATE) <= OP.OBSERVATION_PERIOD_END_DATE AND P.ordinal = 1
-- End Primary Events
