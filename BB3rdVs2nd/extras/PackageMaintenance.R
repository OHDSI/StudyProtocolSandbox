...
OhdsiRTools::checkUsagePackage("BB3rdVs2nd")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/BB3rdVs2nd.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BB3rdVs2nd.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("BB3rdVs2nd")
