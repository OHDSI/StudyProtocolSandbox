...
2. In 'R', use the following code to install the BB3rdVs2nd package:
...
License
=======
The BB3rdVs2nd package is licensed under Apache License 2.0


Development
===========
BB3rdVs2nd was developed in ATLAS and R Studio.
