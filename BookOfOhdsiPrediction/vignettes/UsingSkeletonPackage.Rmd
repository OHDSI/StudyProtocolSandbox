...
Please copy the `BookOfOhdsiPrediction` folder. Choose a name for your study package, and change all references from 'BookOfOhdsiPrediction' to your name of choice in the package code. 
