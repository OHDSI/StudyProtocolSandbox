...
OhdsiRTools::checkUsagePackage("CHADS2Tutorial")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CHADS2Tutorial.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CHADS2Tutorial.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CHADS2Tutorial")
