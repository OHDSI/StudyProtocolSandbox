...
OhdsiRTools::checkUsagePackage("EndOfLifeCare")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EndOfLifeCare.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EndOfLifeCare.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EndOfLifeCare")
