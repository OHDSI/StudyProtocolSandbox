...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (21600744)and invalid_reason is null
...
WHERE DATEADD(day,365,OP.OBSERVATION_PERIOD_START_DATE) <= P.START_DATE AND DATEADD(day,180,P.START_DATE) <= OP.OBSERVATION_PERIOD_END_DATE AND P.ordinal = 1
-- End Primary Events
