...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45775372,40241331,45892847,43013024)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45775372,40241331,45892847,43013024)
  and c.invalid_reason is null
...
WHERE YEAR(C.condition_start_date) - P.year_of_birth > 75
