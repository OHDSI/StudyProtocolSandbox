...
#target cohort
#sql <- readSql("target.sql")
target_sql<-"CREATE TABLE #Codesets (
...
(
  ...
  #comparator cohort
  #sql <- readSql("comparator.sql")
  comparator_sql <- "CREATE TABLE #Codesets (
  codeset_id int NOT NULL,
  concept_id bigint NOT NULL
  )
  ;
  ...
  #outcome cohort
  #sql <- readSql("outcome.sql")
  outcome_sql <- "CREATE TABLE #Codesets (
  codeset_id int NOT NULL,
  concept_id bigint NOT NULL
  )
  ;
