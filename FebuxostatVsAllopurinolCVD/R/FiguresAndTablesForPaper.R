...
createFiguresAndTables <- function(outputFolder,
  ...
  negativeControls <- read.csv(system.file("settings", "NegativeControls.csv", package = "FebuxostatVsAllopurinolCVD"))
  ...
  EvidenceSynthesis::plotCovariateBalances(balances = bal,
                                           ...
                                           fileName = fileName)
  fileName <- system.file("settings", "Table1Specs.csv", package = "FebuxostatVsAllopurinolCVD")
