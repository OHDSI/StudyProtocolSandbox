...
SELECT 'Index Event NSTEMI wo STEMI', COUNT(*), Null, Null, Null, Null, Null, Null, Null FROM (
	...
	WHERE c.ancestor_concept_id = 444406  
	...
	WHERE c.condition_concept_id = 312327 ) d
