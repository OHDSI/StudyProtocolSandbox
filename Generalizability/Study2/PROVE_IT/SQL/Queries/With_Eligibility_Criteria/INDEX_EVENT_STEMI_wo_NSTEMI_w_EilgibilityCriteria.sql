...
SELECT 'Index Event STEMI wo NSTEMI', COUNT(*), Null, Null, Null, Null, Null, Null, Null FROM (
	...
	WHERE c.ancestor_concept_id = 312327  
	...
	WHERE c.ancestor_concept_id =444406 ) d
