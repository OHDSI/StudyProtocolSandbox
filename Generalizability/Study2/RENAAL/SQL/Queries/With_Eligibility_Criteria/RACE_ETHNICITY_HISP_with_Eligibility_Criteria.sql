SELECT 'Race Ethnicity Hispanic', COUNT(d.subject_id), Null, Null, Null, Null, Null, Null, Null FROM (
	SELECT DISTINCT ON (c.subject_id) c.subject_id, c.eth_race FROM
		(
		SELECT b.subject_id,
		CASE
	WHEN b.ethnicity_concept_id = '38003564' AND b.race_concept_id = '8527' THEN 'OTH'
	WHEN b.ethnicity_concept_id = '0' AND b.race_concept_id = '8522' THEN 'OTH'
	...
	WHEN b.ethnicity_concept_id = '0' AND b.race_concept_id = '38003613' THEN 'ASA'
	WHEN b.ethnicity_concept_id = '0' AND b.race_concept_id = '8516' THEN 'AFA'
	WHEN b.ethnicity_concept_id = '38003564' AND b.race_concept_id = '8515' THEN 'ASA'
	...
	WHEN b.ethnicity_concept_id = '0' AND b.race_concept_id = '8552' THEN 'UNK'
	...
	WHEN b.ethnicity_concept_id = '38003564' AND b.race_concept_id = '38003613' THEN 'ASA'
	...
	WHEN b.ethnicity_concept_id = '0' AND b.race_concept_id = '8515' THEN 'ASA'
