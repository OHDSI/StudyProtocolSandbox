...
createAnalysesDetails <- function(outputFolder) {
  ...
  outcomeset <- c(4320,0,1,2,3,4) 
  #composite + any death / any death/ cc death/MI/HF/STROKE
  ...
  dcos2 <- CohortMethod::createDrugComparatorOutcomes(targetId = 13,
                                                      comparatorId = 14,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos2<-list(dcos2)
  
  dcos3 <- CohortMethod::createDrugComparatorOutcomes(targetId = 13,
                                                      comparatorId = 23,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos3<-list(dcos3)
  ...
  dcos5 <- CohortMethod::createDrugComparatorOutcomes(targetId = 13,
                                                      comparatorId = 34,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos5<-list(dcos5)
  
  dcos6 <- CohortMethod::createDrugComparatorOutcomes(targetId = 14,
                                                      comparatorId = 12,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos6<-list(dcos6)
  ...
  dcos8 <- CohortMethod::createDrugComparatorOutcomes(targetId = 14,
                                                      comparatorId = 23,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos8<-list(dcos8)
  
  dcos9 <- CohortMethod::createDrugComparatorOutcomes(targetId = 14,
                                                      comparatorId = 24,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos9<-list(dcos9)
  ...
  dcos11 <- CohortMethod::createDrugComparatorOutcomes(targetId = 34,
                                                      comparatorId = 12,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos11<-list(dcos11)
  
  dcos12 <- CohortMethod::createDrugComparatorOutcomes(targetId = 34,
                                                      comparatorId = 13,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos12<-list(dcos12)
  ...
  dcos13 <- CohortMethod::createDrugComparatorOutcomes(targetId = 34,
                                                      comparatorId = 14,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos13<-list(dcos13)
  
  dcos14 <- CohortMethod::createDrugComparatorOutcomes(targetId = 34,
                                                      comparatorId = 23,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos14<-list(dcos14)
  
  dcos15 <- CohortMethod::createDrugComparatorOutcomes(targetId = 34,
                                                      comparatorId = 24,
                                                      excludedCovariateConceptIds = excludedCovariateConceptIds,
                                                      outcomeIds = outcomeset)
  dcos15<-list(dcos15)
...
##only cmAnalysis1 is used (the codes for cmAnalysis below will not be used)
