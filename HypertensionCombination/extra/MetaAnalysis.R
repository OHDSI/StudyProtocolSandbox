...
nhis<-read.csv(file.path("D:/htn_combi/17.8.17/output/export/180/MainResults.csv"))
...
nhis<-nhis[nhis$outcomeId == 0,]
medicare<-medicare[medicare$outcomeId == 0,]
medicaid<-medicaid[medicaid$outcomeId == 0, ]
...
plotMetaAnalysisForest(logRr = c(nhis[ (nhis$comparatorId==comparatorid & nhis$targetId == targetid), ]$logRr ,
                         medicare[ (medicare$comparatorId==comparatorid & medicare$targetId == targetid), ]$logRr,
                         medicaid[ (medicaid$comparatorId==comparatorid & medicaid$targetId == targetid), ]$logRr),
                       logLb95Ci = log(
                                     c(nhis[ (nhis$comparatorId==comparatorid & nhis$targetId == targetid), ]$ci95lb ,
                                     medicare[ (medicare$comparatorId==comparatorid & medicare$targetId == targetid), ]$ci95lb,
                                     medicaid[ (medicaid$comparatorId==comparatorid & medicaid$targetId == targetid), ]$ci95lb)
                                     ),
                       logUb95Ci = log(
                                     c(nhis[ (nhis$comparatorId==comparatorid & nhis$targetId == targetid), ]$ci95ub ,
                                     medicare[ (medicare$comparatorId==comparatorid & medicare$targetId == targetid), ]$ci95ub,
                                     medicaid[ (medicaid$comparatorId==comparatorid & medicaid$targetId == targetid), ]$ci95ub)
                                     ),
