...
#CD_vs_AD
tabletext= c("MCDCE", 'CV death', 'MI', 'HF', 'Stroke')
...
###Primary and secondary endpoint in subgroups
```{r Primary and secondary endpoint in subgroups, echo=FALSE}
...
bound_rr=cbind(matched_outcome18001$rr,matched_outcome18002$rr,matched_outcome18059$rr,matched_outcome18061$rr)
bound_lower=cbind(matched_outcome18001$ci95lb,matched_outcome18002$ci95lb,matched_outcome18059$ci95lb,matched_outcome18061$ci95lb)
bound_upper=cbind(matched_outcome18001$ci95ub,matched_outcome18002$ci95ub,matched_outcome18059$ci95ub,matched_outcome18061$ci95ub)
...
forestplot(labeltext=tabletext,
           ...
           xticks=c(0.25,0.5,1.0,1.5,2.0,3.0,4.0),
           line.margin = 0.2,
           legend=c("Male","Female","กร60 years", "<60 years")
)
