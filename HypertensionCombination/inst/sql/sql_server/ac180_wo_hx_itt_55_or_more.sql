...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (1335471,1351557,1340128,19050216,1328165,1341927,1346686,1353776,1363749,19122327,1347384,1326012,19004539,19015802,1308216,1367500,19071995,19102106,1310756,1318853,19113063,1319133,1319880,19020061,40226742,1373225,1331235,1334456,1317640,1308842,1307863,19102107)and invalid_reason is null
