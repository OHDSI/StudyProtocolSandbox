...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (1335471,1351557,1340128,1395058,19050216,1341927,1346686,1363749,974166,19122327,978555,1347384,1308216,1367500,907013,1310756,40226742,1373225,1331235,1334456,1317640,1308842,19010493,19102107)and invalid_reason is null
