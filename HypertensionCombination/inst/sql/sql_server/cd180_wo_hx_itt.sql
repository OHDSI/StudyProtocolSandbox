...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (1395058,1328165,1353776,974166,978555,1326012,19004539,19015802,19071995,19102106,907013,1318853,19113063,1319133,1319880,19020061,1307863,19010493)and invalid_reason is null
