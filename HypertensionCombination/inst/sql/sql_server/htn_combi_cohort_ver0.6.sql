,4111707,4111708,4111709,4111710,4111711,4111714,4112018,4112019,4112022,4119140,4120104,4121664,4126076,4129290,4129534,4129535,4130539,4131383,4134162,4134421,4136545,4136546,4137761,4138327,4139778,4141405,4142739,4144154,4145897,4146185,4147995,4148906,4151359,4153352,4154699,4159140,4159152,4162754,4168056,4171122,4171123,4172545,4173332,4173481,4174299,4174848,4176148,4176892,4178726,4180610,4180743,4183593,4185701,4189462,4196275,4196276,4199890,4201028,4201094,4201635,4209442,4211509,4215954,4216353,4217146,4218781,4219010,4224614,4229432,4238315,4242720,4243309,4249574,4250507,4263703,4267862,42872427,42872434,42873042,42873044,42873045,42873046,42873123,42873157,4289598,4299377,4301259,4306943,4310996,4318408,4319146,4319328,4323618,432474,432475,432478,4326561,4327350,432743,432752,432764,4328027,432923,433037,433050,433051,433052,433058,433623,433624,4337830,4338502,433882,433899,434155,434166,434508,4345688,434756,434785,434789,435104,43530669,43530670,43530671,43530674,43530683,43530727,43530728,43530851,43531605,43531607,435378,435390,435391,435672,435931,435938,435959,435960,435964,436258,436430,436519,436526,436553,436557,436841,436842,437106,437133,437388,437413,438003,438279,438285,438595,438596,438873,438894,439040,439171,439182,439194,439847,439932,439944,439949,439950,440236,440244,440250,440251,440531,440537,440561,440869,440870,441158,441432,441709,441985,442341,443454,443752,443790,443864,444091,444196,444197,444198,44782730,44782773,44797721,45766068,45766118,45766119,45766120,45766830,45767658,45772786,45773167,46270031,46270111,46270380,46270381,46271801,46273491,46273649) and invalid_reason is null
...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (317898,4062811,4209293,4277110,44809027,320128,4148205,4215640,44783644,320456,4227607,4269635,4321603,312648,4057978,45757444,314103,314423,4028951,4049389,4263067,4279525,44809548,45757447,4159755,4302591,44809026,4058987,4023318,4179379,4276511,4034031,4167358,4304837,44783643,44811110,45771067,316866,4028741,4269358,43020424,44811933,45768449,4162306,43021830,45757137,4146816,4217486,44800519,45771064,4083723,42873163,45757356,45757787,321638,4151903,4221991,4262182,4311246,321074,44811932,45757139,45757445,321080,40481896,4180283,4199306,4218088,4242878,4289933,44809569,45757446)and invalid_reason is null
...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (1335471,1351557,1340128,19050216,1341927,1346686,1363749,19122327,1347384,1308216,1367500,1310756,40226742,1373225,1331235,1334456,1317640,1308842,19102107
  --add (cetapril, delapril, fimasartan, temocapril)  to ACEi/ARB group
  ,999000,999001,999002,999003)and invalid_reason is null
...
( 
  select concept_id from @cdmDatabaseSchema.CONCEPT where concept_id in (1319998,1314002,1322081,1338005,950370,1346823,19049145,19063575,1386957,1307046,1314577,19024904,1327978,1345858,1353766
  --add (bevantolol)  to BB group
  ,999004)and invalid_reason is null
...
INSERT INTO #inclusionRuleCohorts (inclusion_rule_id, event_id)
select 4 as inclusion_rule_id, event_id
FROM 
(
  select pe.event_id
  FROM #qualified_events pe
...
INSERT INTO #inclusionRuleCohorts (inclusion_rule_id, event_id)
select 5 as inclusion_rule_id, event_id
FROM 
(
  select pe.event_id
  FROM #qualified_events pe
...
DELETE FROM #precohort where cohort_definition_id = 12;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 12 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
...
DELETE FROM #precohort where cohort_definition_id = 21;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 21 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 13;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 13 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 31;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 31 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 14;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 14 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 41;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 41 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 34;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 34 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 43;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 43 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 23;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 23 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 32;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 32 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 24;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 24 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
DELETE FROM #precohort where cohort_definition_id = 42;
INSERT INTO #precohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 42 as cohort_definition_id, F.person_id, F.start_date, F.end_date
FROM (
  select Q.person_id, Q.start_date, E.end_date, row_number() over (partition by Q.event_id order by E.end_date) as ordinal 
  from #qualified_events Q
  join #cohort_ends E on Q.event_id = E.event_id and Q.person_id = E.person_id and E.end_date >= Q.start_date
...
--AGGREGATE COHORT WIHOUT ORDER OF MEDICATION

-- This syntax cannot be translated
--IF OBJECT_ID('@resultsDatabaseSchema.@exposureTable', 'U') IS NULL
CREATE TABLE @resultsDatabaseSchema.@exposureTable(cohort_definition_id INT, subject_id BIGINT, cohort_start_date DATE, cohort_end_date DATE);

DELETE FROM @resultsDatabaseSchema.@exposureTable
WHERE COHORT_DEFINITION_ID = 12;

INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 12 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 12 
	   OR COHORT_DEFINITION_ID = 21
GROUP BY SUBJECT_ID

DELETE FROM @resultsDatabaseSchema.@exposureTable
WHERE COHORT_DEFINITION_ID = 13;

INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 13 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 13
	   OR COHORT_DEFINITION_ID = 31
GROUP BY SUBJECT_ID

DELETE FROM @resultsDatabaseSchema.@exposureTable
WHERE COHORT_DEFINITION_ID = 14;

INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 14 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 14
	   OR COHORT_DEFINITION_ID = 41
GROUP BY SUBJECT_ID

DELETE FROM @resultsDatabaseSchema.@exposureTable
WHERE COHORT_DEFINITION_ID = 23;

INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 23 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 23 
	   OR COHORT_DEFINITION_ID = 32
GROUP BY SUBJECT_ID
...
INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 24 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 24 
	   OR COHORT_DEFINITION_ID = 42
GROUP BY SUBJECT_ID

DELETE FROM @resultsDatabaseSchema.@exposureTable
WHERE COHORT_DEFINITION_ID = 34;

INSERT INTO @resultsDatabaseSchema.@exposureTable
SELECT 34 AS cohort_definition_id, subject_id, min(cohort_start_date) as cohort_start_date, max(cohort_end_date) as cohort_end_date
FROM #precohort
	WHERE COHORT_DEFINITION_ID = 34 
	   OR COHORT_DEFINITION_ID = 43
GROUP BY SUBJECT_ID;
