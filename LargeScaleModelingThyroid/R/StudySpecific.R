#' @title Execute OHDSI Study Large Scale Modeling of Patients with Thyroid Conditions
#'
#' @details
#' This function executes OHDSI Study Large Scale Modeling of Patients with Thyroid Conditions.
#' The objective of this study is to characterise the non-cancerous thyroid disorder population and identify and characterise the sources of variation within treatment pathways for thyroid conditions.
...
#' @keywords internal
getDestinationAddress <- function() { return("burculantonija@gmail.com") }

# Package must provide a default result file name
#' @keywords internal
getDefaultStudyFileName <- function() { return("LargeScaleModelingThyroid.rda") }

# Packge must provide default email subject
#' @keywords internal
getDefaultStudyEmailSubject <- function() { return("LargeScaleModelingThyroid Results") }
