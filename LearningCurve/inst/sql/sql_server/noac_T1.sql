...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (19024063)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19024063)
...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (4108832,313217,314665)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4108832,313217,314665)
  and c.invalid_reason is null
...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (43013024,40228152,40241331)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (43013024,40228152,40241331)
  and c.invalid_reason is null
...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (4281749)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (440417,4133004)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (440417,4133004)
  and c.invalid_reason is null
...
WHERE C.ordinal = 1
AND C.drug_era_start_date > TO_DATE(TO_CHAR(2010,'0000')||'-'||TO_CHAR(09,'00')||'-'||TO_CHAR(30,'00'), 'YYYY-MM-DD')
...
WHERE (OP.OBSERVATION_PERIOD_START_DATE + 365*INTERVAL'1 day') <= P.START_DATE AND (P.START_DATE + 0*INTERVAL'1 day') <= OP.OBSERVATION_PERIOD_END_DATE AND P.ordinal = 1
-- End Primary Events
...
) A on A.person_id = P.person_id and A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= (P.START_DATE + -365*INTERVAL'1 day') and A.START_DATE <= P.OP_END_DATE
