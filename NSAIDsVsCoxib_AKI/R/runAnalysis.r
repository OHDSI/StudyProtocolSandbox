...
# Study: ----
# [SOS_osh] COX2_vs_NSAIDs_hospital 
...
resultsDatabaseSchema <- "Camel_db.dbo"
exposureTable <- "cohort"
outcomeTable <- "cohort"
cdmVersion <- "5" 
outputFolder <- "C:/Users/Songheui OH/Documents/analysis result"
maxCores <- 10 
...
# Get all NSAIDs&COX2 Concept IDs for exclusion ----
sql <- paste("select distinct I.concept_id FROM
             ( 
             select concept_id from @cdm_database_schema.CONCEPT where concept_id in (1118084,1124300,1177480,1178663,1136980,1150345,1113648,1115008,1118045,1189754,1236607)and invalid_reason is null
             UNION  select c.concept_id
             from @cdm_database_schema.CONCEPT c
             join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
             and ca.ancestor_concept_id in (1118084,1124300,1177480,1178663,1136980,1150345,1113648,1115008,1118045,1189754,1236607)
...
cmAnalysis1 <- CohortMethod::createCmAnalysis(analysisId = 1,
                                              description = "[SOS_osh] COX2_vs_NSAIDs_hospital",
