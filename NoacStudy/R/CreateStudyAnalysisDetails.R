...
createAnalysesDetails <- function(outputFolder) {
  ...
  getDbCmDataArgs <- CohortMethod::createGetDbCohortMethodDataArgs(washoutPeriod = 183,
                                                                   # indicationLookbackWindow = 183, # CHANGED
                                                                   studyStartDate = "",
                                                                   studyEndDate = "",
                                                                   excludeDrugsFromCovariates = FALSE,
                                                                   covariateSettings = covarSettings)

  createStudyPopArgs1 <- CohortMethod::createCreateStudyPopulationArgs(removeDuplicateSubjects = TRUE, #CHANGED, added
  ...
  # 1-loe+7, 3-loe+7)
  fitOutcomeModelArgsCrudeCoxAsTreated <- CohortMethod::createFitOutcomeModelArgs(useCovariates = FALSE,
                                                                                  modelType = "cox",
                                                                                  stratified = FALSE)
...
#                                                 fitOutcomeModelArgs = fitOutcomeModelArgsCrudeCoxDelayed30dAsTreated)
  ...
  fitOutcomeModelArgsStratifiedCoxAsTreated <- CohortMethod::createFitOutcomeModelArgs(useCovariates = FALSE,
                                                                                       modelType = "cox",
                                                                                       stratified = TRUE)
  ...
  cmAnalysis9 <- CohortMethod::createCmAnalysis(analysisId = 9,
                                                ...
                                                computeCovariateBalance = FALSE, # CHANGED
                                                fitOutcomeModel = TRUE,
                                                fitOutcomeModelArgs = fitOutcomeModelArgsStratifiedCoxAsTreated)
