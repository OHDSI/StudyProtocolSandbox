...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (4280942,28779,198798,4112183,194382,192671,196436,4338225) and invalid_reason is null
    UNION 
