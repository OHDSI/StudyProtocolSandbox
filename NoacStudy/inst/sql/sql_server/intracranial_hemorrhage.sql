...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (376713,4014781,252477,439847,42873157,436430,432923,435959,439040) and invalid_reason is null
