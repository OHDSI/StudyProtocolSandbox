...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (437312,318556,75345,79864,258449,261687,4208719) and invalid_reason is null
    UNION 

  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (318556,75345,79864,258449,261687,4208719)
