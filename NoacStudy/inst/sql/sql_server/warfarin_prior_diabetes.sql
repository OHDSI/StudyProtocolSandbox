...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (195771) and invalid_reason is null
    UNION 
...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (201254,435216,200687,377821,318712) and invalid_reason is null
    UNION 
...
( 
  select DISTINCT concept_id from @cdm_database_schema.CONCEPT where concept_id in (201826,443734,443767,192279,443735,376065,443729,443732) and invalid_reason is null
    UNION 
