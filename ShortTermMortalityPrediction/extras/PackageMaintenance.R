...
OhdsiRTools::checkUsagePackage("ShortTermMortalityPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ShortTermMortalityPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ShortTermMortalityPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ShortTermMortalityPrediction")
