...
Technology
==========
  TKRrevisionValidation is an R package.
...
#devtools::install_github("OHDSI/StudyProtocolSandbox/TKRrevisionValidation")

library(TKRrevisionValidation)
...
cohortTable <- 'TKNrevisionValidationCohortTable'
...
# Now run the study
TKRrevisionValidation::execute(connectionDetails = connectionDetails,
