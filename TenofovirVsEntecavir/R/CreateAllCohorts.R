...
createCohorts <- function(connectionDetails,
  ...
  pathToCsv <- system.file("settings", "NegativeControls.csv", package = "TenofovirVsEntecavir")
...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "TenofovirVsEntecavir")
