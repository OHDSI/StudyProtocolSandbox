...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (321588,441139,442289,443882,443784)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (321588,441139,442289,443882,443784)
...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (374060,4108356,4110192,4043731)and invalid_reason is null
UNION  select c.concept_id
  from @cdm_database_schema.CONCEPT c
  join @cdm_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
