...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (195771)and invalid_reason is null
...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (201826,443734,443767,192279,443735,376065,443729,443732)and invalid_reason is null
...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (201254,435216,200687,377821,318712)and invalid_reason is null
...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (4150819,4331725)and invalid_reason is null
...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (21600744,21500154)and invalid_reason is null
...
UNION  select c.concept_id
  ...
  and ca.ancestor_concept_id in (21600744,21500154)
...
(
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (730548,1000979,1508439,1510202,19033909)and invalid_reason is null
...
UNION  select c.concept_id
  ...
  and ca.ancestor_concept_id in (730548,1000979,1508439,1510202,19033909)
...
( 
  ...
  select concept_id from @cdm_database_schema.CONCEPT where concept_id = @exposure_id
...
UNION  select c.concept_id
  ...
  and ca.ancestor_concept_id = @exposure_id
...
where de.drug_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 35)
