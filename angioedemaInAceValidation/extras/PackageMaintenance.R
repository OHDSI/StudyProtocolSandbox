...
#
# This file is part of angioedemaInAceValidation
#
...
OhdsiRTools::checkUsagePackage("angioedemaInAceValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/angioedemaInAceValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/angioedemaInAceValidation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("angioedemaInAceValidation")
