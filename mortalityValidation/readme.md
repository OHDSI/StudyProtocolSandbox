...
Technology
==========
  mortalityValidation is an R package.
...
#devtools::install_github("OHDSI/StudyProtocolSandbox/mortalityValidation")

library(mortalityValidation)
...
cohortTable <- 'mortalityValidationCohortTable'
...
# Now run the study
mortalityValidation::execute(connectionDetails = connectionDetails,
