...
#
# This file is part of ohdsi2018live2Validation
#
...
OhdsiRTools::checkUsagePackage("ohdsi2018live2Validation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ohdsi2018live2Validation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ohdsi2018live2Validation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ohdsi2018live2Validation")
