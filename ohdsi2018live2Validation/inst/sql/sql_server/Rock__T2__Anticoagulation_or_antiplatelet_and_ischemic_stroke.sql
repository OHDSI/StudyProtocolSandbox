...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (43013024,40228152,45892847,40241331,1310149)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (43013024,40228152,45892847,40241331,1310149)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1112807,1322184)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1112807,1322184)
  and c.invalid_reason is null
