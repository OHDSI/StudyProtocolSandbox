...
Technology
==========
  ohdsi2018live2Validation is an R package.
...
#devtools::install_github("OHDSI/StudyProtocolSandbox/ohdsi2018live2Validation")

library(ohdsi2018live2Validation)
...
cohortTable <- 'ohdsi2018live2ValidationCohortTable'
...
# Now run the study
ohdsi2018live2Validation::execute(connectionDetails = connectionDetails,
