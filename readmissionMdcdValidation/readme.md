...
Technology
==========
  readmissionMdcdValidation is an R package.
...
#devtools::install_github("OHDSI/StudyProtocolSandbox/readmissionMdcdValidation")

library(readmissionMdcdValidation)
...
cohortTable <- 'readmissionMdcdValidationCohortTable'
...
# Now run the study
readmissionMdcdValidation::execute(connectionDetails = connectionDetails,
