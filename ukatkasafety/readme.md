...
2. In 'R', use the following code to install the UkaTkaSafetyFull package:
...
3. Once installed, you can execute the study by modifying and using the following code:
	...
	outputFolder <- "c:/UkaTkaSafetyFull"
...
Development
===========
UkaTkaSafetyFull was developed in ATLAS and R Studio.
